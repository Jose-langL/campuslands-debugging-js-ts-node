# 🛠️ Reporte de Debugging — Ejercicio 034
...
> vitest run ejercicios/ejercicio-034/tests/tourism.test.ts
 ...
 ✓ ejercicios/ejercicio-034/tests/tourism.test.ts (2 tests) 3ms
   ✓ ejercicio 034 (2)
 ...
 Test Files  1 passed (1)
      Tests  2 passed (2)
   Start at  19:21:02
   Duration  195ms (transform 48ms, setup 0ms, import 66ms, tests 3ms, environment 0ms)
```