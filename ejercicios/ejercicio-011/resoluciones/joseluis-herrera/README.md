# 🛠️ Reporte de Debugging — Ejercicio 011
---
...
> vitest run ejercicios/ejercicio-011/tests/battle-zone.test.js
 ...
 ✓ ejercicios/ejercicio-011/tests/battle-zone.test.js (2 tests) 6ms
   ✓ ejercicio 011 (2)
     ✓ calcula suma numerica y no concatena texto 3ms
     ✓ ordena ranking de mayor a menor puntaje 1ms

 Test Files  1 passed (1)
      Tests  2 passed (2)
   Start at  15:38:20
   Duration  283ms (transform 46ms, setup 0ms, import 72ms, tests 6ms, environment 0ms)
```